...
bl_val_t* bl_mod_init(bl_val_t* ctx) {
     ...
     bl_val_t* nested_ctx2 = bl_ctx_new(ctx);
     ...
     bl_ctx_set(nested_ctx, bl_mk_symbol("nested2"),nested_ctx2);
     bl_ctx_set(nested_ctx2,bl_mk_symbol("teststr2"),bl_mk_str(test_str3));
     return my_ctx;
}
